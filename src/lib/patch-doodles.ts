...
function makeSpecs(seedBase: number): Record<string, PatchDoodleSpec> {
  ...
  const heartAt = (cx: number, cy: number, k = 1) =>
    gen.path(
  ...
  const star5 = (cx: number, cy: number, k = 1) =>
    gen.polygon(
      [
        [cx, cy - 9 * k],
        [cx + 2.4 * k, cy - 2.8 * k],
  ...
  const zzz = (color: string): PatchDoodleSpec => {
    ...
    return { strokes: ds(z(4, 24, 12), z(19, 13, 9), z(30, 5, 6)), colorClass: color };
  };
  ...
  return {
    ...
    rainbow: {
      strokes: ds(
        gen.path("M9 16 A5 5 0 0 1 15 9 A6.5 6.5 0 0 1 27 8 A5 5 0 0 1 32 16 Z", { ...SOFT, ...s() }),
        drop(14, 22, 0.8),
        drop(26, 22, 0.8),
        drop(20, 28, 0.7),
      ),
    ...
    star: {
      strokes: ds(
        gen.path("M25 5 A13 13 0 1 0 34 27 A10 10 0 0 1 25 5 Z", { ...SOFT, ...s() }),
      ),
    ...
    "bear-brown": {
      strokes: ds(heartAt(13, 15, 0.85), heartAt(29, 26, 0.62)),
      colorClass: BERRY,
    },
    ...
    elephant: {
      strokes: ds(gen.circle(19, 21, 28, { ...SOFT, ...s() })),
      dots: [
        { cx: 14, cy: 16, r: 1.8 },
        { cx: 24, cy: 19, r: 1.8 },
        { cx: 17, cy: 27, r: 1.8 },
    ...
    octopus: {
      strokes: ds(gen.circle(20, 20, 30, { ...SOFT, ...s() }), heartAt(20, 20, 0.6)),
      colorClass: SKY,
    },
    ...
    "cosmo-koala": {
      strokes: ds(
        gen.circle(20, 20, 18, { ...SOFT, ...s() }),
        gen.ellipse(20, 21, 38, 10, { ...SOFT, ...s() }),
      ),
      colorClass: GRAPE,
      rotate: -14,
    },
    ...
    "beach-crab": {
      strokes: ds(
        gen.path("M6 16 A14 12 0 0 1 34 16 Z", { ...SOFT, ...s() }),
    ...
    "surfs-up": {
      strokes: ds(
        gen.path("M36 26 Q34 8 18 8 Q6 8 6 18 Q6 26 14 26 Q20 26 20 20", { ...SOFT, ...s() }),
        gen.path("M4 33 Q20 29 36 33", { ...SOFT, ...s() }),
      ),
      colorClass: SKY,
    },
    ...
    "sir-brave": {
      strokes: ds(
        gen.line(20, 3, 20, 26, { ...SKETCH, ...s() }),
        gen.line(12, 26, 28, 26, { ...SOFT, ...s() }),
        gen.line(20, 26, 20, 36, { ...SOFT, ...s() }),
        gen.path("M20 3 L16 8 L20 12 L24 8 Z", { ...SOFT, ...s() }),
      ),
      colorClass: INK,
      rotate: 20,
    },
    ...
    "dj-whiskers": {
      strokes: ds(
        gen.path("M8 24 A12 12 0 0 1 32 24", { ...SOFT, ...s() }),
        gen.rectangle(5, 24, 7, 11, { ...SOFT, ...s() }),
        gen.rectangle(28, 24, 7, 11, { ...SOFT, ...s() }),
      ),
      colorClass: GRAPE,
    },
    ...
    "magic-pop": {
      strokes: ds(gen.line(6, 34, 24, 16, { ...SKETCH, ...s() }), star5(29, 10, 0.9)),
      dots: [
        { cx: 36, cy: 22, r: 1.3 },
        { cx: 20, cy: 6, r: 1.2 },
      ],
    ...
    "hot-rod": {
      strokes: ds(
        gen.path("M13 8 C9 14 7 18 7 23 A6.5 6.5 0 0 0 20 23 C20 18 17 14 13 8 Z", { ...SOFT, ...s() }),
        gen.path("M29 14 C26 19 24 22 24 26 A5.5 5.5 0 0 0 35 26 C35 22 33 19 29 14 Z", { ...SOFT, ...s() }),
      ),
      colorClass: BERRY,
    },
