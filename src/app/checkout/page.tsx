      ...
      <main className="bg-[color:var(--color-surface-blush)] min-h-screen">
        <section className="mx-auto max-w-6xl px-6 md:px-10 py-12 md:py-20 grid gap-10 lg:grid-cols-[1fr_360px]">
          ...
          <aside className="lg:sticky lg:top-24 self-start">
            <div className="rounded-[1.5rem] bg-doodle-canvas border-2 border-dashed border-doodle-ink/20 p-6">
              ...
              <p className="mt-4 font-mono text-[10px] uppercase tracking-[0.18em] text-doodle-ink/45 text-center">
